															...
															<div class='row'>
																<div class='col'>
																	<input
																		...
																		placeholder={youthsInformation.firstName}
																		disabled
																		readonly
																	/>
																</div>
																<div class='col'>
																	<input
																		type='text'
																		class='form-control p-2 bg-light'
																		placeholder={youthsInformation.lastName}
																		disabled
																		readonly
																	/>
																</div>
														...
														<div className='col-7 mx-1'>
															<div class='col-12'>
																<input
																	type='text'
																	class='form-control p-2 bg-light'
																	placeholder={youthsInformation.gender}
																	disabled
																	readonly
																/>
															</div>
														...
														<div className='col-7 mx-1'>
															<div class='col-12'>
																<input
																	type='text'
																	class='form-control p-2 bg-light'
																	placeholder={youthsInformation.codeNumber}
																	disabled
																	readonly
																/>
															</div>
														...
														<div className='col-7 mx-1'>
															<div class='col-12'>
																<input
																	type='text'
																	class='form-control p-2 bg-light'
																	placeholder={youthsInformation.phoneNumber}
																	disabled
																	readonly
																/>
															</div>
														...
														<div className='col-7 mx-1'>
															<div class='col-12'>
																<input
																	...
																	class='form-control p-2 bg-light'
																	id='inputAddress'
																	placeholder={youthsInformation.city}
																	disabled
																	readonly
																/>
															</div>
