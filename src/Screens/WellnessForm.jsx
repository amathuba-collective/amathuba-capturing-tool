...
export default function WellnessForm() {
    ...
    const [agentReflectionQuestions, setAgentReflectionQuestions] = useState(false);
    ...
    const [keyAnswerCaptureConfused1, setKeyAnswerCaptureConfused1] = useState("");
    const [keyAnswerCaptureConfused2, setKeyAnswerCaptureConfused2] = useState("");
    const [keyAnswerCaptureConfused3, setKeyAnswerCaptureConfused3] = useState("");
    const [keyAnswerCaptureConfused4, setKeyAnswerCaptureConfused4] = useState("");
    const [keyAnswerCaptureConfused5, setKeyAnswerCaptureConfused5] = useState("");
    const [keyAnswerCaptureConfused6, setKeyAnswerCaptureConfused6] = useState("");
    const [keyAnswerCaptureConfused7, setKeyAnswerCaptureConfused7] = useState("");
    const [keyAnswerCaptureConfused8, setKeyAnswerCaptureConfused8] = useState("");
    const [keyAnswerCaptureConfused9, setKeyAnswerCaptureConfused9] = useState("");
    const [keyAnswerCaptureConfused10, setKeyAnswerCaptureConfused10] = useState("");
    const [keyAnswerCaptureConfused11, setKeyAnswerCaptureConfused11] = useState("");
    const [keyAnswerCaptureConfused12, setKeyAnswerCaptureConfused12] = useState("");
    const [keyAnswerCaptureConfused13, setKeyAnswerCaptureConfused13] = useState("");
    const [keyAnswerCaptureConfused14, setKeyAnswerCaptureConfused14] = useState("");
    //
    ...
    const [keyAnswerCaptureAnxious10, setKeyAnswerCaptureAnxious10] = useState("");
    const [keyAnswerCaptureAnxious11, setKeyAnswerCaptureAnxious11] = useState("");
    const [keyAnswerCaptureAnxious12, setKeyAnswerCaptureAnxious12] = useState("");
    const [keyAnswerCaptureAnxious13, setKeyAnswerCaptureAnxious13] = useState("");
    const [keyAnswerCaptureAnxious14, setKeyAnswerCaptureAnxious14] = useState("");
    //
    ...
    const [keyAnswerCaptureFollowUp1, setKeyAnswerCaptureFollowUp1] = useState("");
    const [keyAnswerCaptureFollowUp2, setKeyAnswerCaptureFollowUp2] = useState("");
    const [keyAnswerCaptureFollowUp3, setKeyAnswerCaptureFollowUp3] = useState("");
    const [keyAnswerCaptureFollowUp4, setKeyAnswerCaptureFollowUp4] = useState("");
    const [keyAnswerCaptureFollowUp5, setKeyAnswerCaptureFollowUp5] = useState("");
    const [keyAnswerCaptureFollowUp6, setKeyAnswerCaptureFollowUp6] = useState("");
    const [keyAnswerCaptureFollowUp7, setKeyAnswerCaptureFollowUp7] = useState("");
    const [keyAnswerCaptureFollowUp8, setKeyAnswerCaptureFollowUp8] = useState("");
    const [keyAnswerCaptureFollowUp9, setKeyAnswerCaptureFollowUp9] = useState("");
    const [keyAnswerCaptureFollowUp10, setKeyAnswerCaptureFollowUp10] = useState("");
    const [keyAnswerCaptureFollowUp11, setKeyAnswerCaptureFollowUp11] = useState("");
    const [keyAnswerCaptureFollowUp12, setKeyAnswerCaptureFollowUp12] = useState("");
    const [keyAnswerCaptureFollowUp13, setKeyAnswerCaptureFollowUp13] = useState("");
    const [keyAnswerCaptureFollowUp14, setKeyAnswerCaptureFollowUp14] = useState("");
    // 
