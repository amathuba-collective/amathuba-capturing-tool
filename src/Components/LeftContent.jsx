							...
							<div>
								...
								<p className='fs-2 fw-semibold'>
									{props.redOpeningQuestion1 ? (
										...
										<p className='fs-5'>How are things going at work/home ?</p>
					...
					<div className='fw-semilight fs-3 mt-4'>
						{props.redPossibleResponses ? (
							<div>
								...
								<p className='fs-5 fw-semibold'>{props.redPossibleResponses}</p>
							</div>
						) : null}
					</div>
					...
					<div className='fw-semilight fs-3 mt-4'>
						{props.redFollowUpQuestions ? (
							<div>
								...
								<p className='fs-5 fw-semibold'>{props.redFollowUpQuestions}</p>
